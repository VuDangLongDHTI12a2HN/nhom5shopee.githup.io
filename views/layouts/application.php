...
<body>
	<header id='header'>
		<img style="margin-top: 10px; margin-left: 30px; height: 150px; width: 300px;" src="images/logoshope.png" alt="">
		...
		<div class="header-detail">
			<p>218 Lĩnh Nam,Hoàng Mai, Hà Nội, Việt Nam<br>
	...
	<nav class="navbar navbar-default" role="navigation" id="nav">
		<div class="container-fluid">
			...
			<div class="navbar-header">
				...
				<a class="navbar-brand logo" href="">Shopee</a>
			...
			<div class="collapse navbar-collapse navbar-ex1-collapse">
				...
				<div class="navbar-form navbar-right searchbox-desktop">
					<div class="form-group" style="width: 400px">
						<input style="width: 400px" type="text" class="form-control" placeholder="Bạn tìm gì?" id='srch-val'>
					</div>
					<span class="btn btn-primary" id="searchBtn" style="border-color: #fff;background-color: #db551b; ">Tìm</span>
				</div>
			</div><!-- /.navbar-collapse -->
		</div>
	</nav>
	...
	<footer>
		<div class="container-fluid">
			<div class="row" style="background-color: #db551b">
				<div class="col-lg-8" style="text-align: center; padding: 20px 0;background-color: #db551b">
				...
				<div class="col-lg-4" id="contact" style="background-color: #db551b">
					<h3>Contact</h3>
					<i class="glyphicon glyphicon-map-marker"></i><span> Lĩnh Nam, Hoàng Mai , Hà Nội</span><br>
					<i class="glyphicon glyphicon-earphone"></i><span> 0989728267</span><br>
					<i class="glyphicon glyphicon-envelope"></i><span> Shopee@gmail.com</span><br>
				...
				<div class="col-lg-12" id="copyright-txt">
					<b>All right reverse, &#169; copyright of Shopee.com</b>
				</div>
			</div>
		</div>
	</footer>
